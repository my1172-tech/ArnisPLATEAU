...
fn buildings_to_osm_data(buildings: &[GsiBuilding]) -> OsmData {
    ...
    for building in buildings {
        ...
        // GSI buildings default to flat roofs to prevent gabled roof generation
        // over existing OSM buildings sharing the same footprint.
        tags.insert("roof:shape".to_string(), "flat".to_string());
